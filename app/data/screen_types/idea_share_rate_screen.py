...
class ShareRateScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.box_layout.add_widget(HeartfeltHellosButton(text=f"Share with {friend}", size_hint_y=None, height='50dp'))
        ...
        self.box_layout.add_widget(HeartfeltHellosButton(text="View Follow-Up Ideas", size_hint_y=None, height='40dp'))
